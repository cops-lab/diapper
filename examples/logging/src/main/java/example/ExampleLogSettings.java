...
public class ExampleLogSettings implements ILogSettings {

    public void setLogLevel(LogLevel level) {

        // these properties configure slf4j-simple
        ...
        // this configures the behavior of java.util.logging (JUL) and bridges all JUL
        // logging to comparable SLF4J log levels
